...
export const onSubmitMicroorganismo = ({
    DESCRIPCION,
    ESTADO
}) => {  
    return userService.CreateMicroorganismo(
        DESCRIPCION,
        ESTADO
    ).then(() =>
    {
...
export const onSubmitUpdateMicroorganismo = ({
    ID,
  DESCRIPCION,
  ESTADO
}) => {
    return userService.EditMicroorganismo(
        ID,
        DESCRIPCION,
        ESTADO
    ).then(() =>
...
export const getListMicroorganismo = (ID, ESTADO, cookie) => {
    return userService.GetlistMicroorganismo(
        (ID == null ? "" : ID),
        (ESTADO == null ? "" : ESTADO),
        cookie
    ).catch((error) => {
