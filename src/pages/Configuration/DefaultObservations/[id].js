...
function CreatePage({cookie,id}) {
  ...
  return (
    <>
      <Head>
        <title>{`Edicion de Observacion | Bitácora BD`}</title>
        <meta
          name="description"
          content={`Lugar donde edita la observacion predeterminada que seleccionaran despues las bitacoras`}
        />
        ...
        <meta
          name="twitter:title"
          content={`Edicion de Observacion - Bitácora BD`}
        />
        <meta
